...
from rlkit.torch.sac.policies_v2 import TanhGaussianPolicyV2
from rlkit.torch.sac.sac import SACTrainer
from rlkit.torch.sac.sac_v2 import SACv2Trainer
...
def experiment(variant, agent="SAC"):
    ...
    if agent == "SAC":
        ...
        expl_policy = TanhGaussianPolicyV2(
            obs_dim=obs_dim,
            action_dim=2,
            qf1=qf1,
            qf2=qf2,
